    ...
    <div className='container'>
      ...
      <div className="row">
        ...
        <div className='col-md-6 px-3'>
          <div className="row card bg-light mb-3 ">
            <div className="card-body">
              <h4 className="card-title">Are you planning to track vaccination data?</h4>
              <p className="card-text">The COVID Tracking Project is not tracking data about COVID-19 vaccine distribution and administration for the US as a whole, but as of January 27, 2021, we do display CDC data on vaccinations in long-term care facilities on our data page. We will also be keeping a close eye on how states define and report vaccination metrics and will be maintaining internal logs and annotations about interesting features of this data.</p>
            </div>
          </div>
        </div>
        <div className='col-md-6 px-3'>
          <div className="row card bg-light mb-3 ">
            <div className="card-body">
              <h4 className="card-title">Why are you guys putting in time and resources to do this while not gaining a single penny from it?</h4>
              <p className="card-text">Because it affects all of us. Today it's someone else who is getting infected; tomorrow it could be us. We need to prevent the spread of this virus. We need to document the data so that people with knowledge can use this data to make informed decisions.</p>
            </div>
          </div>
        </div>
        <div className='col-md-6 px-3'>
